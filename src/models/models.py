...
class Configuration(BaseModel):
    media_server_name = CharField(default='The Server', verbose_name='Media Server Name', null=True)
    prefix_keyword = CharField(default='!df', verbose_name='Chat-Prefix For Requests', null=True)
    ...
    session_timeout = IntegerField(default=60, verbose_name='Session Timeout', null=True)
    max_check_time = IntegerField(default=600, verbose_name='Monitoring Timeout (Seconds)', null=True)
    max_results = IntegerField(default=0, verbose_name='Max Search Results', null=True)
    max_seasons_for_non_admin = IntegerField(default=0, verbose_name='Max Seasons For Non-Admin', null=True)

    is_verbose_logging = BooleanField(default=False, verbose_name='Verbose logging in console')
    ...
    is_trailers_enabled = BooleanField(default=True, verbose_name='Enable YouTube Trailers')
