# Generated by Django 4.2.4 on 2023-11-14 02:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discord_servers', models.ManyToManyField(blank=True, related_name='users', to='DiscoFlixClient.discordserver')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('requests', models.ManyToManyField(blank=True, related_name='users', to='DiscoFlixClient.mediarequest')),
